...
import { Heart, Sparkles, Users, Award, Truck, Watch, Home, Plane } from "lucide-react";
...
function AboutPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 md:py-16">
      ...
      {/* Bangla story */}
      <section className="mt-8 rounded-3xl border border-border bg-gradient-to-br from-primary/5 via-card to-card p-6 shadow-[var(--shadow-card)] md:p-10">
        <h2 className="text-2xl font-extrabold md:text-3xl">
