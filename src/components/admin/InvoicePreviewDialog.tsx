...
<style>
  ...
  * { box-sizing: border-box; }
  body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", "Noto Sans Bengali", Roboto, sans-serif; color:#111; margin:0; padding:0; }
  .invoice { width: 100%; max-width: 760px; margin: 0 auto; }
  table { width: 100%; border-collapse: collapse; }
  .barcode-strip { display:flex; height:56px; align-items:stretch; gap:1px; }
