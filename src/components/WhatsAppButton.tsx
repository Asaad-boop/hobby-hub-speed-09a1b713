...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-20 right-4 z-30 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[oklch(0.65_0.18_150)] text-white shadow-[0_12px_32px_-8px_oklch(0.65_0.18_150/0.6)] transition-all hover:scale-110 active:scale-95 lg:bottom-6 lg:right-6 lg:h-16 lg:w-16"
    >
