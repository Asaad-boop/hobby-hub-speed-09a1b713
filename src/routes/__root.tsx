...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "HobbyShop — Unique Gadgets & Gifts" },
      { property: "og:description", content: "Trending gadgets, DIY kits, home decor and gifts at unbeatable prices." },
