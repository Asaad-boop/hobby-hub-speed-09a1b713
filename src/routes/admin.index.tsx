...
function AdminDashboard() {
  ...
  const cards = [
    ...
    { label: "Orders", value: stats?.orders ?? "—", icon: ShoppingBag, to: "/admin/orders" as const, color: "text-emerald-600 bg-emerald-500/10" },
    { label: "Revenue", value: stats ? `৳${stats.revenue.toLocaleString()}` : "—", icon: TrendingUp, to: "/admin/orders" as const, color: "text-amber-600 bg-amber-500/10" },
  ];
