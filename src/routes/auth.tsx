...
import { Loader2, Mail, Lock, User as UserIcon, Eye, EyeOff, ShieldCheck, Sparkles, Truck } from "lucide-react";
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="rounded-3xl border border-border/60 bg-background/80 p-6 shadow-[0_24px_60px_-24px_oklch(0.585_0.245_27.5/0.25)] backdrop-blur-xl sm:p-8">
            ...
            <button
              ...
              className="mb-5 flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-border bg-background text-sm font-semibold text-foreground transition hover:bg-muted"
            >
