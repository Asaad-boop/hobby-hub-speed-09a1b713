  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 md:py-12">
        ...
        {/* Tablet & Desktop: horizontal scroller with arrows */}
        <div className="relative hidden sm:block">
          ...
          >
            {categories.map(({ name, icon: Icon, count, tone }) => (
              <button
                key={name}
                className="group relative w-[calc((100%-1.5rem)/3)] shrink-0 snap-start overflow-hidden rounded-2xl border border-border bg-card p-4 text-left transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-[var(--shadow-elevated)] lg:w-[calc((100%-2.25rem)/4)]"
              >
                <div
          ...
          <button
            ...
            className="absolute -left-3 top-1/2 z-10 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-background/95 text-foreground shadow-[var(--shadow-elevated)] backdrop-blur transition hover:bg-primary hover:text-primary-foreground"
          >
          ...
          <button
            ...
            className="absolute -right-3 top-1/2 z-10 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full border border-border bg-background/95 text-foreground shadow-[var(--shadow-elevated)] backdrop-blur transition hover:bg-primary hover:text-primary-foreground"
          >
